$(function() {
    ...
    $('.list_fail').css('color','#ff4001');
    // 渲染订单
    get_order('unfinish',function(res) {
        render(res);
    })
    // 分页
    var num = 0; //订单数量
    ...
    get_order_number('unfinish',function(res) {
        $('.page').remove();
        num = res[0].count;
    ...
    function render(res) {
        ...
        var $order_top = `
        <div class='order'>
            <p class='order_head'>未完成订单 <span class='head_num'>2</span></p>
            <table>
                <tr>
                    <th class='order_img'>
                        商品图
        ...
        var $orderArr = res.map(function(e,i) {
            ...
            <tr>
                ...
                <td class='order_state'>
                    ...
                    <span class='crit' data-id='${e.order_id}' data-statu='${e.order_state}'>${order_text}</span>
                </td>
                <td class='order_more'>
